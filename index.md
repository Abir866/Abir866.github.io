...
- 📋 **Resume** :[resume_web_dev_toufiq][resume]
...
- 💻 **Experience**:
    ...
    - _**Customer Service Representative**_ @ Atlantic Superstore  
      **[Food portion preparations, anticipate needs, personalize solutions, build rapport]**
- 🛠️ **Best Project**: [Pyhton-Resume maker](https://github.com/Abir866/Scraper) (added [OpenRouter/Deep Seek v-](https://openrouter.ai/deepseek/deepseek-v4-flash) to control web content driven text generation with the help of [Selenium](https://www.selenium.dev/documentation/webdriver/elements/finders/) and became it's maintainer)
- ✉️ **Contact**: [LinkedIn][linkedin] | [Email][email]
- 🎉 **Fun Fact**: I am a learning Linux through NixOS. Check out my config here: [nix-dotfiles][nix_config]
...
- **Focus**:  
  [![Python][img_python]][python] [![Nix][img_nix]][nix] [![Shell][img_shell]][zsh]
- **Others**:  
  Agile, C/C++, CI/CD, Containers, Data Analytics, Game Development, Git, Java, JavaScript, Linux, MongoDB, PHP, SQL, Test Automation, Web Development

<!-- Links -->

[resume]: https://abir866.github.io/My-Typst-Resume/Resume_Toufiq_(resume_starter).pdf "Resume - Toufiq Abir Farhan Tufan"
...
[nix_config]: https://github.com/Abir866/nixos "toufiq/nix-config"
